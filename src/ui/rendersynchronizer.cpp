...
/*
 * Класс не дает вызвать рендеринг со стороны JavaScript интерпретатора,
 * пока инстанция QQuickWindow не сообщила об окончании предидущего
 * рендеринга
 *
 * Высокопроизводительно предотвращает наезды, связанные с изменением древа
